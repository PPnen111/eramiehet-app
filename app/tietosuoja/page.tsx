...
export default function TietosuojaPage() {
  return (
    <main className="min-h-screen bg-[#f5f0e8] px-4 py-10 pb-24">
      <div className="mx-auto max-w-2xl">
        ...
        <h1 className="mb-1 text-3xl font-extrabold text-[#1a1a1a]">Tietosuojaseloste</h1>
        <p className="mb-10 text-sm text-[#4a4a4a]">Päivitetty 11.4.2026</p>

        <div className="space-y-8 text-sm leading-7 text-[#1a1a1a]">

          {/* 1 */}
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1a1a1a]">1. Rekisterinpitäjä ja käsittelijä</h2>
            <p className="mb-3">
              <strong className="text-[#1a1a1a]">JahtiPro</strong><br />
              Yhteyshenkilö: Pekka Paunonen<br />
              Sähköposti:{' '}
              <a href="mailto:info@jahtipro.fi" className="text-[#2d6a2d] underline hover:text-[#1e3d1e]">
                info@jahtipro.fi
              </a><br />
              Verkkosivu: jahtipro.fi
            </p>
            <div className="rounded-xl border border-[#e0d8cc] bg-white px-4 py-3 text-[#1e3d1e]">
              <p className="font-medium text-[#1a1a1a] mb-1">Multi-tenant -malli</p>
              <p>
          ...
          {/* 2 */}
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1a1a1a]">2. Kerättävät henkilötiedot</h2>
            <p className="mb-2">Sovellus kerää seuraavia henkilötietoja:</p>
            <ul className="ml-4 list-disc space-y-1 text-[#1e3d1e]">
          ...
          {/* 3 */}
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1a1a1a]">3. Tietojen käyttötarkoitus</h2>
          ...
          {/* 4 */}
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1a1a1a]">4. Käsittelyn oikeusperuste (GDPR art. 6)</h2>
            <ul className="ml-4 list-disc space-y-2 text-[#1e3d1e]">
              <li>
                <strong className="text-[#1a1a1a]">Sopimus (art. 6.1.b):</strong>{' '}
              ...
              <li>
                <strong className="text-[#1a1a1a]">Oikeutettu etu (art. 6.1.f):</strong>{' '}
                Tietoturvalokien ylläpito palvelun turvallisuuden varmistamiseksi ja
                väärinkäytösten estämiseksi.
              </li>
              <li>
                <strong className="text-[#1a1a1a]">Lakisääteinen velvoite (art. 6.1.c):</strong>{' '}
          ...
          {/* 5 */}
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1a1a1a]">5. Tietojen säilytysajat</h2>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[#e0d8cc]">
                    <th className="px-3 py-2 text-left text-xs text-[#2d6a2d]">Tietotyyppi</th>
                    <th className="px-3 py-2 text-left text-xs text-[#2d6a2d]">Säilytysaika</th>
                  </tr>
                </thead>
                <tbody className="text-[#1e3d1e]">
                  <tr className="border-b border-[#e0d8cc]/30"><td className="px-3 py-2">Jäsentiedot</td><td className="px-3 py-2">Jäsenyyden ajan + 5 vuotta</td></tr>
                  <tr className="border-b border-[#e0d8cc]/30"><td className="px-3 py-2">Tapahtumaloki</td><td className="px-3 py-2">24 kuukautta</td></tr>
                  <tr className="border-b border-[#e0d8cc]/30"><td className="px-3 py-2">Maksutiedot</td><td className="px-3 py-2">10 vuotta (kirjanpitolaki)</td></tr>
                  <tr className="border-b border-[#e0d8cc]/30"><td className="px-3 py-2">Saalisilmoitukset</td><td className="px-3 py-2">Toistaiseksi (tilastointitarve)</td></tr>
          ...
          {/* 6 */}
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1a1a1a]">6. Tietojen luovutus ja alikäsittelijät</h2>
            <p className="mb-2">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[#e0d8cc]">
                    <th className="px-3 py-2 text-left text-xs text-[#2d6a2d]">Palvelu</th>
                    <th className="px-3 py-2 text-left text-xs text-[#2d6a2d]">Käyttötarkoitus</th>
                    <th className="px-3 py-2 text-left text-xs text-[#2d6a2d]">Sijainti</th>
                    <th className="px-3 py-2 text-left text-xs text-[#2d6a2d]">Siirtoperuste</th>
                  </tr>
                </thead>
                <tbody className="text-[#1e3d1e]">
                  <tr className="border-b border-[#e0d8cc]/30">
          ...
          {/* 7 */}
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1a1a1a]">7. Rekisteröidyn oikeudet</h2>
            <p className="mb-2">Sinulla on EU:n yleisen tietosuoja-asetuksen mukaisesti oikeus:</p>
            <ul className="ml-4 list-disc space-y-1 text-[#1e3d1e]">
              <li><strong className="text-[#1a1a1a]">Tarkastusoikeus</strong> — Pyytää tiedot siitä, mitä henkilötietoja sinusta on tallennettu</li>
              <li><strong className="text-[#1a1a1a]">Oikaisuoikeus</strong> — Korjata virheelliset tai puutteelliset tiedot</li>
              <li><strong className="text-[#1a1a1a]">Poisto-oikeus</strong> — Pyytää tietojesi poistamista (&quot;oikeus tulla unohdetuksi&quot;)</li>
              <li><strong className="text-[#1a1a1a]">Rajoittamisoikeus</strong> — Rajoittaa tietojesi käsittelyä tietyissä tilanteissa</li>
              <li><strong className="text-[#1a1a1a]">Siirto-oikeus</strong> — Siirtää tietosi toiseen palveluun koneluettavassa muodossa</li>
              <li><strong className="text-[#1a1a1a]">Valitusoikeus</strong> — Tehdä valitus tietosuojaviranomaiselle</li>
            </ul>
            <div className="mt-3 rounded-xl border border-[#e0d8cc] bg-white px-4 py-3 text-[#1e3d1e]">
              <p>
                Voit tarkastella ja muokata tietojasi kirjautumalla sovellukseen ja menemällä{' '}
                <Link href="/profiili" className="font-medium text-[#2d6a2d] underline hover:text-[#1e3d1e]">
                  Profiili-sivulle
                </Link>
                . Muut pyynnöt:{' '}
                <a href="mailto:info@jahtipro.fi" className="text-[#2d6a2d] underline hover:text-[#1e3d1e]">
          ...
          {/* 8 */}
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1a1a1a]">8. Evästeet</h2>
            <p>
          ...
          {/* 9 */}
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1a1a1a]">9. Tietoturva</h2>
            <ul className="ml-4 list-disc space-y-1 text-[#1e3d1e]">
          ...
          {/* 10 */}
          <section>
            <h2 className="mb-2 text-base font-bold text-[#1a1a1a]">10. Yhteystiedot</h2>
            <p>
